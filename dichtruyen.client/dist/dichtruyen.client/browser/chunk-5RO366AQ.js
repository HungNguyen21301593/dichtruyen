...
var QueueAction = class extends AsyncAction {
  ...
  schedule(state2, delay = 0) {
    if (delay > 0) {
      return super.schedule(state2, delay);
    }
    this.delay = delay;
    this.state = state2;
  ...
  execute(state2, delay) {
    return delay > 0 || this.closed ? super.execute(state2, delay) : this._execute(state2, delay);
  }
  requestAsyncId(scheduler, id, delay = 0) {
...
@angular/animations/fesm2022/animations.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-5RO366AQ.js.map
